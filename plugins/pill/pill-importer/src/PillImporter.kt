...
object PillImporter {
    ...
    @JvmStatic
    fun run(rootProject: Project, taskName: String, platformDir: File, embeddedConfigurationName: String) {
        EmbeddedComponents.CONFIGURATION_NAME = embeddedConfigurationName

        val tasks = JpsCompatiblePluginTasks(rootProject, platformDir)
