...
class JpsCompatiblePluginTasks(private val rootProject: Project, private val platformDir: File) {
    private companion object {
        ...
        fun getProjectLibraries(rootProject: Project): List<PLibrary> {
            ...
            val libraries = rootProject.allprojects
                .mapNotNull { library ->
                    val libraryExtension = library.findPillExtensionMirror()
    ...
    private fun initEnvironment() {
        ...
        platformVersion = rootProject.extensions.extraProperties.get("versions.intellijSdk").toString()
        ...
        isAndroidStudioPlatform = rootProject.extensions.extraProperties.has("versions.androidStudioRelease")
    }
    ...
    fun pill() {
        ...
        val variant = Variant.values().firstOrNull { it.name == variantOptionValue }
            ?: run {
        ...
        if (variant == Variant.NONE || variant == Variant.DEFAULT) {
